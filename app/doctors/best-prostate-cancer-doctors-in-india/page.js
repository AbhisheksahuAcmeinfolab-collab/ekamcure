                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-[#E1E8F0] p-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <Link
                          ...
                          className="group flex items-center bg-[#F8FAFD] border border-[#E1E8F0] rounded-xl px-5 py-4 hover:border-pink-500 hover:bg-gradient-to-r hover:from-[#053161] hover:to-[#6796cc] transition-all duration-300"
                        >
