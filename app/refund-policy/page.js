        ...
        <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-8 md:p-12">
          ...
          <ul className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              Cancellation requests must be sent in writing via email to <strong>info@ekamcure.com,
              </strong> along with the relevant service booking ID and valid identification. In the case of visa rejection, a
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              feel free to reach out to us at <strong>info@ekamcure.com</strong> or call us at <strong>+91-9990205353.</strong>
            </p>
          </ul>
        </div>
      </section>
