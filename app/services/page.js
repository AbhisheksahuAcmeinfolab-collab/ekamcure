            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="bg-[#053161] hover:bg-[#1B4F9C] px-6 py-3 rounded-lg font-semibold transition text-white text-center flex items-center justify-center gap-2 shadow-md"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
                  ...
                  Call Our Experts (+91-9990205353)
                </a>
              
                {/* Appointment Form Link */}
                <Link
                  href="/contact"
                  className="border border-[#053161] text-[#053161] hover:bg-[#053161] hover:text-white px-6 py-3 rounded-lg font-semibold transition text-center"
                >
                  Appointment Form
                </Link>
              </div>
