...
import img from "../../assets/recent/ourfees.webp";
    ...
    <>
      ...
      <section className="w-full bg-gray-50 py-12 px-6 md:px-20 font-karla text-[17px]">
        ...
        <div className="text-center max-w-12xl mx-auto px-6 md:px-12 py-10 ">
          <p className=" text-black leading-relaxed font-karla text-[17px]">
        ...
        <div className="text-center mb-10 font-karla text-[17px]">
          <h2 className="text-3xl md:text-4xl font-bold text-[#172962]">
            Choose Your Plan
          </h2>
          <p className="mt-2 text-black text-lg">
            Transparent pricing for every medical traveler
          </p>
          <div className="w-20 h-1 bg-[#172962] mx-auto mt-4 rounded-full" />
        </div>
        ...
        <section className="py-16 bg-white text-center">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-karla text-[17px] ">
              {/* BASIC PLAN */}
              <div className="bg-white rounded-xl shadow-md p-8 border-5 border-blue-[#334155] md:h-160">
                <h3 className="text-black font-['Raleway'] text-[32px] font-bold tracking-[0.7px] m-0">
                  Basic Plan
                </h3>
                <p className="text-black font-karla text-[17px] mb-6">
                  Perfect for individuals who need essential medical travel
                  guidance.
                </p>

                <div className="-mx-8 mb-5 bg-[#0910572e] flex justify-center py-2">
                ...
                {/* Features */}
                <ul className="font-['Roboto'] text-[17px] tracking-[0.5px] space-y-3 mb-6 text-justify">
                  {basicFeatures.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <FaCheck className="text-[#172962] mt-1 flex-shrink-0" />
                      <span className="text-black leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>

                <p className="text-bold text-black mb-6 font-karla text-[17px]">
              ...
              {/* PREMIUM PLAN */}
              <div className="bg-white rounded-xl shadow-md p-8 border-5 border-blue-[#334155] font-karla text-[17px]">
                <h3 className="text-black font-['Raleway'] text-[32px] font-bold tracking-[0.7px] m-0">
                  Comprehensive Plan
                </h3>
                <p className="text-black-[#000000] font-karla text-[17px] mb-6">
                ...
                <p className="font-karla text-[17px] text-black mb-6">
