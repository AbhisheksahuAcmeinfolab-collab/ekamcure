...
//   // 🔵 AUTO-SLIDE CONTROL (Fix)
//   useEffect(() => {
//     if (isPaused) return; // ⛔ When paused → stop slider completely
...
//         >
//           {patients.slice(current * 2, current * 2 + 2).map((p, i) => (
//             <div key={i} className="p-4 bg-white shadow-md rounded-xl border">
...
//       {/* PAUSE INDICATOR */}
//       <div className="absolute bottom-4 right-4 text-xs bg-black text-white px-3 py-1 rounded-lg">
