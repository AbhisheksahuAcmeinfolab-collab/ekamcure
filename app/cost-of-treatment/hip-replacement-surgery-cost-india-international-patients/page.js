          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-[#E1E8F0] shadow-sm p-6">
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3 text-sm font-medium">
                <a href="#cost-overview" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Hip Replacement Cost Overview
                </a>
                <a href="#what-is-included" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • What Is Included
                </a>
                <a href="#factors-affecting-cost" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Factors Affecting Cost
                </a>
                <a href="#international-patients" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Cost for International Patients
                </a>
                <a href="#personalized-estimate" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Personalized Estimate
                </a>
                <a href="#extra-costs" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Extra Costs to Budget For
                </a>
                <a href="#estimated-budget" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Medical Tourism Budget
                </a>
                <a href="#why-choose-india" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • Why Choose India?
                </a>
                <a href="#ekam-process" className="text-[#1B4F9C] hover:text-pink-600 transition">
                  • How Ekam Helps
                </a>
                <a href="#choosing-hospital" className="text-[#1B4F9C] hover:text-pink-600 transition">
            ...
            <article className="bg-white rounded-2xl shadow-sm border border-[#E1E8F0] overflow-hidden">
              <div className="p-6 md:p-10 lg:p-12">
                ...
                {/* WHAT IS INCLUDED */}
                <section id="what-is-included" className="mb-12">
                  <SectionHeading>
                  ...
                  <BulletList
                    items={[
                      "Orthopaedic surgeon's professional fees",
                      "Anaesthetist fees",
                      "Operating-room and surgical charges",
                      "Hip implant and related surgical components",
                      "Pre-operative investigations",
                      "Hospital room and nursing care",
                      "Medicines and consumables used during hospitalization",
                      "Post-operative monitoring",
                      "Physiotherapy during the hospital stay",
                      "Follow-up assessment before discharge",
                    ]}
                  />
                ...
                <section id="factors-affecting-cost" className="mb-12">
                  ...
                  <NumberedSection
                    number="1"
                    title="Type of Hip Replacement"
                    text="The cost can differ depending on whether the patient requires a total hip replacement, partial hip replacement, bilateral hip replacement or revision surgery. Revision procedures may involve additional surgical complexity and specialized implants."
                  />

                  <NumberedSection
                    number="2"
                    title="Type and Brand of Hip Implant"
                    text="The implant is an important component of the overall treatment cost. Different implant designs, materials, bearing surfaces and manufacturers can have different prices. The surgeon generally recommends an implant based on factors such as the patient's age, bone quality, activity level, anatomy and clinical requirements rather than price alone."
                  />

                  <NumberedSection
                    number="3"
                    title="Hospital and Location"
                    text="Treatment costs can vary between hospitals and cities. International patients may receive different quotations depending on the hospital's infrastructure, room category, specialist fees, facilities and package structure."
                  />

                  <NumberedSection
                    number="4"
                    title="Surgeon's Experience and Expertise"
                    text="The surgeon's professional fees can form part of the overall treatment cost. Complex cases may require an orthopaedic surgeon with specific expertise in primary or revision joint replacement."
                  />

                  <NumberedSection
                    number="5"
                    title="Pre-operative Tests"
                    text="Before surgery, the patient may require blood tests, X-rays, ECG, imaging or other medical assessments. The exact investigations depend on the patient's condition and the hospital's pre-operative protocol."
                  />

                  <NumberedSection
                    number="6"
                    title="Length of Hospital Stay"
                    text="The number of days spent in the hospital can affect the final bill. Published estimates commonly place hospital stay after hip replacement at approximately 3–5 days, although the actual duration depends on recovery and the treating team's assessment."
                  />

                  <NumberedSection
                    number="7"
                    title="Additional Medical Requirements"
                    text="Patients with other medical conditions or complications may require additional investigations, medicines, specialist consultations or extended hospitalization. These expenses may not be part of a standard package."
                  />
                </section>
                ...
                <section id="international-patients" className="mb-12">
                  ...
                  <BulletList
                    items={[
                      "Remote medical consultation before travel",
                      "Medical record and diagnostic-report review",
                      "Airport transfer",
                      "Assistance with hospital admission",
                      "Interpreter or language assistance where required",
                      "Accommodation outside the hospital",
                      "Local transportation",
                      "Medical visa-related expenses",
                      "Post-discharge stay in India",
                ...
                {/* PERSONALIZED ESTIMATE */}
                <section id="personalized-estimate" className="mb-12">
                  <SectionHeading>
                ...
                {/* EXTRA COST */}
                <section id="extra-costs" className="mb-12">
                  ...
                  <NumberedSection
                    number="1"
                    title="Doctor Consultation and Medical Evaluation"
                ...
                {/* BUDGET */}
                <section id="estimated-budget" className="mb-12">
                  <SectionHeading>
                ...
                <section id="why-choose-india" className="mb-12">
                  ...
                  <p className="text-[#425466] text-base md:text-lg leading-8 mb-5">
                    ...
                    <strong>
                      <Link
                        href="/treatments/hip-replacement-surgery-in-india#cost-india"
                        className="text-blue-600 hover:underline"
                      >
                ...
                {/* EKAM PROCESS */}
                <section id="ekam-process" className="mb-12">
                  <SectionHeading>
                ...
                {/* CHOOSING HOSPITAL */}
                <section id="choosing-hospital" className="mb-12">
                  <SectionHeading>
                ...
                {/* MORE RELATED LINKS SECTION (AT END OF LEFT CONTENT) */}
                <section className="pt-6 border-t border-[#E1E8F0]">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 text-sm">
                    {moreRelatedLinks.map((link, idx) => (
                      <Link
                        key={idx}
                        href={link.href}
                        className="p-3 rounded-xl border border-[#E1E8F0] bg-[#F8FAFD] text-[#1B4F9C] hover:text-pink-600 hover:border-pink-300 font-medium transition block"
                      >
                        • {link.title}
                      </Link>
                    ))}
              ...
              <div className="space-y-3 text-sm">
                {sidebarRelatedArticles.map((article, index) => (
                  <Link
                    key={index}
                    href={article.href}
                    className="block text-[#425466] hover:text-[#1B4F9C] hover:font-semibold transition-all py-1.5 border-b border-gray-100 last:border-0"
                  >
                    • {article.title}
                  </Link>
                ))}
