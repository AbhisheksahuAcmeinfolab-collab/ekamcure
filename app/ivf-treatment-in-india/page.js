...
// // import motherImg from "/images/pic2.jpg"; // ← replace with your image path
...
//       {/* CONTENT WRAPPER */}
//       <div className="relative max-w-7xl mx-auto w-full grid md:grid-cols-2 items-center gap-10 px-6">
//         {/* LEFT TEXT */}
    ...
    <>
      ...
      `}
        ...
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:grid-cols-1 md:grid-cols-2 md:text-4xl font-semibold text-center text-[#082859] mb-10">
            {activeTab}
          </h2>

          {/* GRID LIST BASED ON ACTIVE TAB */}
          <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6">
            {tabData[activeTab].map((item, index) => (
              <div
                key={index}
                className="flex bg-white rounded-xl shadow-sm p-5 gap-4 justify-center"
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#082859] mb-2">
                    {item.title}
                  </h3>
