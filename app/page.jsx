        ...
        <div className="relative max-w-xl mx-auto xl:w-[570px]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* MOBILE VIEW */}
              <div className="relative flex md:hidden w-full justify-center -ml-12 mx-auto">
                {/* Text Box */}
                ...
                <div className="absolute top-1/2 right-[-14px] -translate-y-1/2 w-[130px] sm:w-[100px] bg-white border-2 border-blue-900 rounded-xl overflow-hidden shadow-lg z-10 ">
                  <Image
                    src={currentPatient.media}
                    alt={currentPatient.name}
