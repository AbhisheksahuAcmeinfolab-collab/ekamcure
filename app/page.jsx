...
import pic5 from "../assets/newimage/Cancer Treatment.webp";
import pic6 from "../assets/newimage/Cosmetic Surgeries.webp";
import pic7 from "../assets/newimage/Dental Treatments.webp";
import pic8 from "../assets/newimage/Ear, Nose, and Throat (ENT).webp";
import pic9 from "../assets/newimage/Gender Reassignment Surgery.webp";
import pic10 from "../assets/newimage/General Medicine.webp";
...
export default function Home() {
  ...
  return (
    <main>
      <section className="relative w-full h-[75vh] flex items-center justify-center overflow-hidden bg-transparent">
        ...
        <div className="relative z-10 text-center px-6 md:px-12 lg:px-20 max-w-4xl">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.p
                className="mt-40 lg:text-2xl text-2xl py-4 font-medium text-gray-200 max-w-2xl mx-auto"
              ...
              <div className="mt-8 flex justify-center gap-4 flex-wrap">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold px-8 py-3 rounded-full shadow-xl transition duration-300"
                >
                  Get Free Quote
                </motion.button>
                <motion.button
...
//             <motion.p
//               className="mt-4 lg:text-2xl py-4 font-medium text-gray-200 max-w-2xl mx-auto"
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.6 }}
//             >
