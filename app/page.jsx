...
//               />
//               <span className="mt-2 text-sm text-gray-700 text-center">{country.name}</span>
//             </div>
//           ))}
//         </div>
//       </div>
...
//       <div className="overflow-hidden w-full max-w-6xl mx-auto py-10 mb-6">
//         <motion.div
...
//             <div
//               key={index}
//               className="min-w-[300px] flex-shrink-0 rounded-lg shadow-lg overflow-hidden"
//             >
//               <div className={`h-48 relative ${item.color}`}>
//                 <Image
//                   src={item.image}
//                   alt={item.title}
//                   fill
...
//       <div className="w-full max-w-3xl mx-auto px-4 py-10 text-center">
//         <h2 className="text-3xl font-bold mb-6 text-blue-700">
//           Happy Patients
//         </h2>
//         <div className="bg-white shadow-lg rounded-xl p-6 transition-all duration-500 ease-in-out">
