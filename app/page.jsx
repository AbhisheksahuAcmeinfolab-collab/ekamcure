...
// const specialties = [
//   { name: "Cardiology", icon: "/icons/heart.png" },
//   { name: "Cosmetology & Dermatology", icon: "/icons/skin.png" },
//   { name: "Dental", icon: "/icons/tooth.png" },
//   { name: "GI & Bariatric", icon: "/icons/stomach.png" },
//   { name: "Nephrology & Urology", icon: "/icons/kidney.png" },
//   { name: "Neuro / Spine", icon: "/icons/brain.png" },
//   { name: "Obstetrics & Gynecology", icon: "/icons/female.png" },
//   { name: "Oncology", icon: "/icons/cancer.png" },
//   { name: "Ophthalmology", icon: "/icons/eye.png" },
//   { name: "Organ Transplant", icon: "/icons/organ.png" },
//   { name: "Orthopedic", icon: "/icons/bone.png" },
// ];
...
//     Explore <span className="text-red-500 font-bold">Top Specialties</span>
//   </h2>
//   <p className="text-gray-600 max-w-3xl mx-auto mb-10">
//     We handle treatments that range from life-saving surgeries to procedures
//     that restore confidence. Some of the most sought-after treatments
//     include
//   </p>
...
//       <div
//         key={index}
//         className="w-full max-w-[280px] bg-white border rounded-xl shadow-sm hover:shadow-md transition-shadow p-5 flex flex-col items-center text-center"
//       >
//         <div className="w-16 h-16 flex items-center justify-center bg-red-50 rounded-xl mb-4">
//           <Image
//             src={item.icon}
//             alt={item.name}
//             width={48}
...
import pic6 from "../assets/newimage/cancer.webp";
import pic7 from "../assets/newimage/cardiac.webp";
import pic8 from "../assets/newimage/orthopedic.webp";
import pic9 from "../assets/newimage/dentist.webp";
  ...
  return (
    <main>
      ...
      {/* <section className="py-16 px-6 md:px-12 lg:px-20 bg-white text-center">
        <h2 className="text-2xl md:text-3xl font-semibold mb-2">
          Explore{" "}
          <span className="text-red-500 font-bold">Top Specialties</span>
        </h2>
        <p className="text-gray-600 max-w-3xl mx-auto mb-10">
          We handle treatments that range from life-saving surgeries to
          procedures that restore confidence. Some of the most sought-after
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-items-center">
          {specialties.map((item, index) => (
            <div
              ...
              className="w-full max-w-[280px] bg-white border rounded-xl shadow-sm hover:shadow-md transition-shadow p-5 flex flex-col items-center text-center"
            >
              <div className="w-20 h-5 flex items-center justify-center bg-red-50 rounded-xl mb-4">
                <Image
                  src={item.icon}
                  alt={item.alt}
                  width={100}
