        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-10 gap-8 px-4 py-10">
          ...
          <div className="lg:col-span-7 order-2">
            ...
            <div className="bg-white p-6 rounded-xl shadow mb-10">
              ...
              <p className="text-gray-700 mt-4">
                At Ekam Cure, we understand that choosing the right IVF centre in India can be challenging, especially for international patients seeking affordable, high-quality fertility treatment. We proudly assist patients from Nigeria, Kenya, Ghana, Tanzania, Uganda, Ethiopia, Zambia, Zimbabwe, Rwanda, South Sudan, Sudan, Malawi, Sierra Leone, Liberia, DR Congo, Bangladesh, Nepal, the Maldives, Fiji, Papua New Guinea, the Solomon Islands, and other countries. Our dedicated medical tourism team manages every step of your journey-from selecting the best IVF specialist and hospital to online doctor consultations, personalized treatment planning, medical visa assistance, airport transfers, accommodation arrangements, language support, and comprehensive post-treatment follow-up-ensuring a smooth, safe, and stress-free IVF experience in India.
              </p>
              <p className="text-gray-700 mt-4">
