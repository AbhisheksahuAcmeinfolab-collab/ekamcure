          ...
          <aside className="space-y-6 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="bg-white rounded-2xl border border-[#E1E8F0] shadow-sm p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <a href="#what-is-success-rate" className="block text-[#1B4F9C] hover:text-pink-500 transition">
                  Success Rate Factors
                </a>
                <a href="#how-measured" className="block text-[#1B4F9C] hover:text-pink-500 transition">
                  How Success Is Measured
                </a>
                <a href="#how-long-lasts" className="block text-[#1B4F9C] hover:text-pink-500 transition">
                  Implant Longevity
                </a>
                <a href="#factors-affecting" className="block text-[#1B4F9C] hover:text-pink-500 transition">
                  Factors Affecting Outcomes
                </a>
                <a href="#age-groups" className="block text-[#1B4F9C] hover:text-pink-500 transition">
                  Older vs Younger Patients
                </a>
                <a href="#complications-revision" className="block text-[#1B4F9C] hover:text-pink-500 transition">
                  Complications & Revision
                </a>
                <a href="#evaluating-statistics" className="block text-[#1B4F9C] hover:text-pink-500 transition">
