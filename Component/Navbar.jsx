...
//                 {item.name}
//                 {isActive && (
//                   <span className="absolute left-0 -bottom-1 h-1 w-full bg-blue-600 rounded-full" />
//                 )}
//               </Link>
//             );
//           })}
...
//           <LanguageChanger id="google_translate_element" />
//         </div>
...
//             exit={{ opacity: 0, y: -20 }}
//             className="xl:hidden px-4 pb-4 space-y-2 bg-white shadow-md rounded-b-md"
//           >
//             {navItems.map((item) => {
//               const isActive = pathname === item.href;
//               return (
...
//             <div className="pt-2">
//               <LanguageChanger id="google_translate_element_mobile" />
//             </div>
//           </motion.div>
//         )}
//       </AnimatePresence>
